...
const creators = [
  { id: 1, name: "Alex.eth", prompts: 24, followers: "5.2K", image: "/placeholder.svg?height=100&width=100" },
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {creators.map((creator) => (
            <Card key={creator.id} className="bg-gray-900 border-gray-800 hover:border-purple-500 transition-all">
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">{creator.prompts} prompts</p>
                  </div>
                </div>
