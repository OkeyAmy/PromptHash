  ...
  return (
    <section className="py-16 px-6 bg-gray-950">
      <div className="mx-auto max-w-7xl">
        <h2 className="text-2xl font-bold tracking-tight text-white mb-8">Explore the App Store</h2>
            ...
            <Link href={`/category/${category.id}`} key={category.id}>
              <div className="relative group overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-4">
                  ...
                  <p className="text-sm text-gray-300">{category.count} prompts</p>
                </div>
              </div>
            </Link>
          ))}
        ...
        <div className="mt-8 text-center">
          <Button className="bg-purple-600 hover:bg-purple-700">View All Categories</Button>
        </div>
      </div>
    </section>
  )
